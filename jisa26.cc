 ...
 * Billing Min PDR: 99%
 * 
 * IMR Max Delay: 1 minuto = 60 s
 * AN Max Delay: 3 s = 3000 ms
 */
 ...
 double simulationTimeSeconds = 24 * 2 * 60 * 60; //!< Scenario duration (s) in simulated time
 ...
 double pccDelay = 3 * 1000; //!< 3000ms (3s) => AN
 ...
 main(int argc, char* argv[])
 {
     ...
     if (adrEnabled)
     {
       if (adrName == "adr")
       {
          ...
          Config::SetDefault("ns3::AdrComponent::MultipleGwCombiningMethod", 
